Ext.define('Admin.Tab.Menu', {
    extend: 'AppController',
    name: 'Admin.Tab.Menu',
    title: 'Menú', layout: 'fit', id: 'tab_menu', closable: true,
    constructor: function(config){
        ...
        return this.treegrid = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
                ...
                { text: 'Módulo', width: 200, dataIndex: 'module', sortable: false },
                { text: 'Script', flex: 1, dataIndex: 'script', sortable: false },
        ...
        if(!this.menu_item){
            this.menu_item = Ext.create('Ext.menu.Menu', {
                plain: true,
                items: [
        ...
        // console.log(drop_node, dropPosition, root_node);
...
Ext.define('Wnd.Menu', {
    ...
    title: 'Menú', modal: true, border: false, width: 650, height: 500, layout: 'fit', //closeAction: 'hide',
    minimizable: false,
    app : { record: null, callback: function(){}, negocio_id: 0 },
    constructor: function(config){
        config.items = [];
            ...
            items:[
                {
                	...
                	items: [
                        ...
                        //     // }
                        // },
	                    { xtype: 'textareafield', fieldLabel: 'Descripción', name: 'description', emptyText: 'Escriba una descripción.', columnWidth: 1, allowBlank: true },
                        { xtype: 'uxcombobox', fieldLabel: 'Módulo', name: 'module_uid', value: '', emptyText: 'Seleccione un Módulo', url: App.url('modulos'), params: { action: 'combobox' }, columnWidth: 1 },
	                    { xtype: 'textareafield', fieldLabel: 'Script', name: 'script', emptyText: '', columnWidth: 1, allowBlank: true },
